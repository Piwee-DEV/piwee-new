		...
		if(!$('.blu-customizer').hasClass('opened')){
			...
			$('#show-adspots').on('change', function(e){
				...
				if(!$(this).is(':checked')){
					...
					/* #1 */
					$('#site').prepend('<div class="adspot-demo spot_above_menu spot_above_menu-html"><img src="http://www.arius.is/katla/wp-content/themes/blt-katla/_demo/assets/img/adspot_1.jpg"></div>');
					/* #2 */
					$('#site-body').prepend('<div class="adspot-demo spot_below_menu spot_below_menu-html"><img src="http://www.arius.is/katla/wp-content/themes/blt-katla/_demo/assets/img/adspot_2.jpg"></div>');
					/* #3 */
					$('.single #site-content-column').prepend('<div class="adspot-demo spot_above_content spot_above_content-html"><img src="http://www.arius.is/katla/wp-content/themes/blt-katla/_demo/assets/img/adspot_3.jpg"></div>');
					/* #4 */
					var i = 0;
					$('.home #site-content-column article').each(function(){
						...
						if(i % 3 == 0){
							...
							$(this).after('<div class="adspot-demo spot_between_posts spot_between_posts-html"><img src="http://www.arius.is/katla/wp-content/themes/blt-katla/_demo/assets/img/adspot_4.jpg"></div>');
							i = 0;
						}

					});
					/* #5 */
					$('.single .post-thumbnail-area').after('<div class="adspot-demo spot_below_content spot_below_content-html"><img src="http://www.arius.is/katla/wp-content/themes/blt-katla/_demo/assets/img/adspot_5.jpg"></div>');
