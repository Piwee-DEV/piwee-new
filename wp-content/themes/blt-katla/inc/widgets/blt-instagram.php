...
class blt_instagram extends WP_Widget{
	...
	function blt_instagram(){
	    $this->WP_Widget('blt_instagram', 'Bluthemes - Instagram', array('classname' => 'blt_instagram bw_slider', 'description' => __( 'Displays recent instagram images in a widget. Recommended for the sidebar.', 'bluthemes')));
	}
