...
class blt_socialbox extends WP_Widget{
	...
	function blt_socialbox(){

		$this->WP_Widget('blt_socialbox', 'Bluthemes - Socialbox', array('classname' => 'blt_socialbox clearfix', 'description' => 'Displays links to social networks in a stylish manner'));
	}
