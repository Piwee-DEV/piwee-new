...
<div class="header-v1">
    <?php if ( $bd_data['show_top_nav'] ) {?>
        <div class="top-bar">
            <div class="container">
                ...
                wp_nav_menu(array('container_class' => 'top-menu', 'theme_location' => 'topmenu', 'fallback_cb' => ''));
                echo "\n".'</div>'."\n";
                ...
                if ( $bd_data['show_top_nav_contactinfo'] )
                {
                    echo stripslashes( bd_topbar_contact_info() );
                }
                echo "\n".'</div>'."\n";
                ?>
                <div class="clear"></div>
    ...
    <div class="container">
        <?php
        global $bd_data;
        if(array_key_exists('show_header_ads',$bd_data))
        {
