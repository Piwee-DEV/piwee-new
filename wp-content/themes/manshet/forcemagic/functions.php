...
function pattrens_bg($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
        ...
        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat'){ echo 'class="selectd"'; } ?>>
            ...
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat'){ echo 'checked="checked"'; } ?> type="radio" value="none" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat1'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-1"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat1'){ echo 'checked="checked"'; } ?> type="radio" value="pat1" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat2'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-2"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat2'){ echo 'checked="checked"'; } ?> type="radio" value="pat2" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat3'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-3"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat3'){ echo 'checked="checked"'; } ?> type="radio" value="pat3" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat4'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-4"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat4'){ echo 'checked="checked"'; } ?> type="radio" value="pat4" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat5'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-5"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat5'){ echo 'checked="checked"'; } ?> type="radio" value="pat5" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat6'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-6"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat6'){ echo 'checked="checked"'; } ?> type="radio" value="pat6" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat7'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-7"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat7'){ echo 'checked="checked"'; } ?> type="radio" value="pat7" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat8'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-8"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat8'){ echo 'checked="checked"'; } ?> type="radio" value="pat8" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat9'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-9"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat9'){ echo 'checked="checked"'; } ?> type="radio" value="pat9" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat10'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-10"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat10'){ echo 'checked="checked"'; } ?> type="radio" value="pat10" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat11'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-11"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat11'){ echo 'checked="checked"'; } ?> type="radio" value="pat11" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat12'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-12"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat12'){ echo 'checked="checked"'; } ?> type="radio" value="pat12" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat13'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-13"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat13'){ echo 'checked="checked"'; } ?> type="radio" value="pat13" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat14'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-14"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat14'){ echo 'checked="checked"'; } ?> type="radio" value="pat14" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat15'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-15"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat15'){ echo 'checked="checked"'; } ?> type="radio" value="pat15" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat16'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-16"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat16'){ echo 'checked="checked"'; } ?> type="radio" value="pat16" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat17'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-17"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat17'){ echo 'checked="checked"'; } ?> type="radio" value="pat17" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat18'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-18"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat18'){ echo 'checked="checked"'; } ?> type="radio" value="pat18" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat19'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-19"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat19'){ echo 'checked="checked"'; } ?> type="radio" value="pat19" />
        </li>

        <li <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat20'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans pat-20"></span>
            <input name="bd_setting[pattrens_bg]" <?php if($bd_option['bd_setting']['pattrens_bg'] == 'pat20'){ echo 'checked="checked"'; } ?> type="radio" value="pat20" />
        </li>
...
function theme_colors($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
        ...
        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color1'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-1"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color1'){ echo 'checked="checked"'; } ?> type="radio" value="color1" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color2'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-2"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color2'){ echo 'checked="checked"'; } ?> type="radio" value="color2" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color3'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-3"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color3'){ echo 'checked="checked"'; } ?> type="radio" value="color3" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color4'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-4"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color4'){ echo 'checked="checked"'; } ?> type="radio" value="color4" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color5'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-5"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color5'){ echo 'checked="checked"'; } ?> type="radio" value="color5" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color6'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-6"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color6'){ echo 'checked="checked"'; } ?> type="radio" value="color6" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color7'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-7"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color7'){ echo 'checked="checked"'; } ?> type="radio" value="color7" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color8'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-8"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color8'){ echo 'checked="checked"'; } ?> type="radio" value="color8" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color9'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-9"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color9'){ echo 'checked="checked"'; } ?> type="radio" value="color9" />
        </li>

        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color10'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-10"></span>
            <input name="bd_setting[theme_colors]" <?php if($bd_option['bd_setting']['theme_colors'] == 'color10'){ echo 'checked="checked"'; } ?> type="radio" value="color10" />
        </li>
...
function footer_layout($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
        ...
        <li <?php if($bd_option['bd_setting']['footer_layout'] == 'col1'){ echo 'class="selectd"'; } ?>>
            ...
            <input name="bd_setting[footer_layout]" <?php if($bd_option['bd_setting']['footer_layout'] == 'col1'){ echo 'checked="checked"'; } ?> type="radio" value="col1" />
        </li>

        <li <?php if($bd_option['bd_setting']['footer_layout'] == 'col2'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="col2">
                <img alt="" src="<?php echo BD_ADMIN_IMG; ?>/footer-col2.png" /></a>
            <input name="bd_setting[footer_layout]" <?php if($bd_option['bd_setting']['footer_layout'] == 'col2'){ echo 'checked="checked"'; } ?> type="radio" value="col2" />
        </li>

        <li <?php if($bd_option['bd_setting']['footer_layout'] == 'col3'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="col3">
                <img alt="" src="<?php echo BD_ADMIN_IMG; ?>/footer-col3.png" /></a>
            <input name="bd_setting[footer_layout]" <?php if($bd_option['bd_setting']['footer_layout'] == 'col3'){ echo 'checked="checked"'; } ?> type="radio" value="col3" />
        </li>

        <li <?php if($bd_option['bd_setting']['footer_layout'] == 'col4'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="col4">
                <img alt="" src="<?php echo BD_ADMIN_IMG; ?>/footer-col4.png" /></a>
            <input name="bd_setting[footer_layout]" <?php if($bd_option['bd_setting']['footer_layout'] == 'col4'){ echo 'checked="checked"'; } ?> type="radio" value="col4" />
        </li>
    </ul>
    <?php
    echo '</div>'."\n";
...
function header_style($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout ttip">
        <li <?php if($bd_option['bd_setting']['header_style'] == 'v1'){ echo 'class="selectd"'; } ?>>
            ...
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v1'){ echo 'checked="checked"'; } ?> type="radio" value="v1" />
        </li>

        <li <?php if($bd_option['bd_setting']['header_style'] == 'v6'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="Header Layout">
                <img alt=" " src="<?php echo BD_ADMIN_IMG; ?>/header-6.png" /></a>
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v6'){ echo 'checked="checked"'; } ?> type="radio" value="v6" />
        </li>

        <li <?php if($bd_option['bd_setting']['header_style'] == 'v2'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="Header Layout">
                <img alt=" " src="<?php echo BD_ADMIN_IMG; ?>/header-2.png" /></a>
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v2'){ echo 'checked="checked"'; } ?> type="radio" value="v2" />
        </li>

        <li <?php if($bd_option['bd_setting']['header_style'] == 'v3'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="Header Layout">
                <img alt=" " src="<?php echo BD_ADMIN_IMG; ?>/header-3.png" /></a>
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v3'){ echo 'checked="checked"'; } ?> type="radio" value="v3" />
        </li>

        <li <?php if($bd_option['bd_setting']['header_style'] == 'v4'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="Header Layout">
                <img alt=" " src="<?php echo BD_ADMIN_IMG; ?>/header-4.png" /></a>
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v4'){ echo 'checked="checked"'; } ?> type="radio" value="v4" />
        </li>

        <li <?php if($bd_option['bd_setting']['header_style'] == 'v5'){ echo 'class="selectd"'; } ?>>
            <a href="#" title="Header Layout">
                <img alt=" " src="<?php echo BD_ADMIN_IMG; ?>/header-1.png" /></a>
            <input name="bd_setting[header_style]" <?php if($bd_option['bd_setting']['header_style'] == 'v5'){ echo 'checked="checked"'; } ?> type="radio" value="v5" />
        </li>
    </ul>
    <br class="clear" />
    <?php
...
function layout_type($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
        <li <?php if($bd_option['bd_setting']['layout_type'] == 'layout_boxed'){ echo 'class="selectd"'; } ?>>
            ...
            <input name="bd_setting[layout_type]" <?php if($bd_option['bd_setting']['layout_type'] == 'layout_boxed'){ echo 'checked="checked"'; } ?> type="radio" value="layout_boxed" />
        </li>
        <li <?php if($bd_option['bd_setting']['layout_type'] == 'layout_full'){ echo 'class="selectd"'; } ?>>
            ...
            <input name="bd_setting[layout_type]" <?php if($bd_option['bd_setting']['layout_type'] == 'layout_full'){ echo 'checked="checked"'; } ?> type="radio" value="layout_full" />
        </li>
    </ul>
    <?php
    echo '</div>'."\n";
...
function bgop($input,$head = true)
{
    ...
    <div class="color-area">
        ...
        <input id="<?php echo $input['id']; ?>_color" class="input_numb color_input " type="text" name="bd_setting[<?php echo $input['id']; ?>][color]" value="<?php echo $current_value['color'] ; ?>" />
    </div>
    ...
    <select class="tybo-weight" name="bd_setting[<?php echo $input['id']; ?>][repeat]" id="<?php echo $input['id']; ?>[repeat]">
    ...
    <select class="tybo-weight" name="bd_setting[<?php echo $input['id']; ?>][attachment]" id="<?php echo $input['id']; ?>[attachment]">
    ...
    <select class="tybo-weight" name="bd_setting[<?php echo $input['id']; ?>][hor]" id="<?php echo $input['id']; ?>[hor]">
    ...
    <select class="tybo-weight" name="bd_setting[<?php echo $input['id']; ?>][ver]" id="<?php echo $input['id']; ?>[ver]" >
    ...
    <div class="clear"></div>
    <input id="<?php echo $input['id']; ?>" class="<?php $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name; ?> img-path upload-url bd-upload-url" type="text" name="bd_setting[<?php echo $input['id']; ?>][img]" value="<?php echo $current_value['img']; ?>">
    ...
    <div class="upload_img" id="<?php echo $input['id']; ?>_img" <?php if( !$current_value['img']  ) echo 'style="display:none;"' ?> >
        ...
        <a href="#" class="btn remove_img" id="<?php echo $input['id']; ?>_remove"><?php _e('Remove','bdayh') ?></a>
    </div>
    <?php
    echo '</div>'."\n";
    if($head == true)
...
function tybo($input,$head = true)
{
    ...
    <select class="tybo-size" name="bd_setting[<?php echo $input['id']; ?>][size]" id="<?php echo $input['id']; ?>[size]">
    ...
    <select class="tybo-weight" name="bd_setting[<?php echo $input['id']; ?>][weight]" id="<?php echo $input['id']; ?>[weight]">
    ...
    <select class="tybo-style" name="bd_setting[<?php echo $input['id']; ?>][style]" id="<?php echo $input['id']; ?>[style]" >
    ...
    <select class="tybo-font" name="bd_setting[<?php echo $input['id']; ?>][font]" id="<?php echo $input['id']; ?>[font]">
    ...
    <div class="gfont_preview">The quick brown fox jumps over the lazy dog</div>
    <script type="text/javascript">
        jQuery(document).ready(function()
        {
            jQuery('.tybo-font').change(function()
            {
                jQuery('.gfont_preview').attr('style','font-famliy:'+ jQuery(this).val());
            });
        });
    </script>
    <?php
...
function sellist($input,$head = true)
{
    ...
    ?>
    <select name="bd_setting[<?php echo $input['id']; ?>]" id="<?php echo $input['id']; ?>">
...
function images($input,$head = true)
{
    ...
    echo '<input name="bd_setting['. $input['id'] .']['. $input['key'] .']" id="'. $input['id'] .'['. $input['key'] .']" type="radio" value="'. $currentValue[$input['key']] .'" /> '."\n";
...
function tags_input($input,$head = true)
{
    ...
    $class_name = (isset($input['class'])) ? $input['class'] : "";
    echo '<input id="'. $input['id'].'" class="'.$class_name .'" type="text" name="bd_setting['. $input['id'].']" value="'. $bd_option['bd_setting'][$input['id']] .'">';
...
function radio_input($input,$head = true)
{
    ...
    ?>
        ...
        <label class="check_radio">
            <input class="on-of r_<?php echo $input['id'];?> <?php $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name; ?>" name="bd_setting[<?php echo $input['id']; ?>]" id="<?php echo $input['id']; ?>" type="radio" value="<?php echo $key ?>" <?php if($bd_option['bd_setting'][$input['id']] == $key){echo 'checked="checked"';}?>>
...
function select($input,$head = true)
{
    ...
    $class_name = (isset($input['class'])) ? $input['class'] : "";
    echo '<select  class="'. $class_name .'" name="bd_setting['. $input['id'] .']" >';
...
function upload_input($input,$head = true)
{
    ...
    ?>
    <input id="<?php echo $input['id']; ?>" class="<?php $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name; ?> img-path upload-url bd-upload-url" type="text" name="bd_setting[<?php echo $input['id']; ?>]" value="<?php echo $bd_option['bd_setting'][$input['id']]; ?>">
...
function ui_slider($input,$head = true)
{
    ...
    echo '<input id="'. $input['id'].'_input" class="input_num_f" type="text" name="bd_setting['. $input['id'].']" value="'. (int)$bd_option['bd_setting'][$input['id']].'">' ."\n";
...
function textarea($input,$head = true)
{
    ...
    else
    {
        ...
        $text_code = $functionbase_encode(get_option('bdayh_setting'));
    }
    echo '<textarea id="'.$input['id'].'" class="'.$class_name.'" name="bd_setting['.$input['id'].']" rows="7">'.$text_code.'</textarea>' ."\n";
    if($input['id'] != 'advanced_export')
    {
...
function checkbox_input($input,$head = true)
{
    ...
    ?>
        <input type="checkbox" id="<?php echo $input['id']; ?>" <?php if(isset($bd_option['bd_setting'][$input['id']]) and $bd_option['bd_setting'][$input['id']] == 1){echo ' checked="checked"';}?> class="<?php $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name; ?>" name="bd_setting[<?php echo $input['id']; ?>]"  value="1" /></div>
    <?php
    if($head == true)
    {
        //echo '</div>'."\n";
...
function txt($input,$head = true)
{
    ...
    echo '<input name="bd_setting['. $input['id'] .']['. $input['key'] .']" id="'. $input['id'] .'['. $input['key'] .']" type="text" value="'. $currentValue[$input['key']] .'" /> </div>'."\n";
    if($head == true)
    {
        //echo '</div>'."\n";
    }
...
function text_input($input,$head = true)
{
    ...
    echo '<input id="'.$input['id'].'" class="'. $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name .'" type="text" value="'. stripslashes($bd_option['bd_setting'][$input['id']]) .'" name="bd_setting['. $input['id'].']" /> </div>'."\n";
    if($head == true)
    {
        //echo '</div>'."\n";
    }
...
function bd_home_builder($input,$head = true)
{
    ...
    <div class="bd_item">
        <div class="bd_option_item">
            <div class="check_radio_content">
                <label class="check_radio"><input id="home_type_blog" name="bd_setting[home_type]" class="home_type" type="radio" <?php if($bd_option['bd_setting']['home_type'] == 'blog'){ ?>checked="checked" <?php } ?> value="blog" /><div class="lab"><?php _e(' Blog Layout - Latest Posts Formats','bdayh') ?></div> </label>
                <label class="check_radio"><input id="home_type_box" name="bd_setting[home_type]" class="home_type" <?php if($bd_option['bd_setting']['home_type'] == 'box'){ ?>checked="checked" <?php }?> type="radio" value="box" /><div class="lab"><?php _e('News, Magazin Boxes','bdayh') ?></div></label>
            </div>
            <div class="clear"></div>
        </div>
    </div>
    <div class="box_type_content" id="box_type_content" <?php if($bd_option['bd_setting']['home_type'] == 'blog'){ ?> style="display:none;" <?php } ?>>
        <ul class="navbuilder">
            <li class="link1"><a href="#" id="add_news"><?php _e('+ News Box','bdayh') ?></a></li>
            <li class="link5"><a href="#" id="add_videos"><?php _e('+ Videos','bdayh') ?></a></li>
            <li class="link6"><a href="#" id="add_gallery"><?php _e('+ Gallery','bdayh') ?></a></li>
            <li class="link2"><a href="#" id="add_recent_box"><?php _e('+ Recent Posts','bdayh') ?></a></li>
            <li class="link3"><a href="#" id="add_scrolling_box"><?php _e('+ Scrolling Box','bdayh') ?></a></li>
            <li class="link4"><a href="#" id="add_ads_box"><?php _e('+ Ads','bdayh') ?></a></li>
        </ul>
    ...
    <script id="bd_add_gallery" type="text/x-tmpl">
        <div>
            <div class="builder_inner" id="home_box_{{= data}}">
                <input type="hidden" name="bd_setting[home][{{= data}}][type]" value="gallery_box" />

                <div class="boxes_title">
                    <a class="handle " original-title="Move Box"><?php _e('MoveBox','bdayh') ?></a>
                    <?php _e('Photo Albums','bdayh') ?>
                    <a class="del" id="remove_{{= data}}" title="<?php _e('Remove Box','bdayh') ?>"><?php _e('Remove Box','bdayh') ?></a>
                    <span class="settings"><?php _e('Settings','bdayh') ?></span>
                </div>
                ...
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
                        ...
                        <div class="bd_option_item">
                            <h3><?php _e('Title','bdayh') ?> </h3>
                            <input type="text" name="bd_setting[home][{{= data}}][title]" value="Photo Albums">
                        </div>

                        <div class="bd_option_item">
                            <h3><?php _e('Number of posts','bdayh') ?> </h3>
    ...
    <script id="bd_add_videos" type="text/x-tmpl">
        <div>
            <div class="builder_inner" id="home_box_{{= data}}">
                <input type="hidden" name="bd_setting[home][{{= data}}][type]" value="videos_box" />

                <div class="boxes_title">
                    <a class="handle " original-title="Move Box"><?php _e('MoveBox','bdayh') ?></a>
                    <?php _e('Latest videos','bdayh') ?>
                    <a class="del" id="remove_{{= data}}" title="<?php _e('Remove Box','bdayh') ?>"><?php _e('Remove Box','bdayh') ?></a>
                    <span class="settings"><?php _e('Settings','bdayh') ?></span>
                </div>
                ...
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
                        ...
                        <div class="bd_option_item">
                            <h3><?php _e('Title','bdayh') ?> </h3>
                            <input type="text" name="bd_setting[home][{{= data}}][title]" value="Latest Videos">
                        </div>

                        <div class="bd_option_item">
                            <h3><?php _e('Number of posts','bdayh') ?> </h3>
                            <input class="input_numb" name="bd_setting[home][{{= data}}][number]" type="text" value="2">
                        </div>
    ...
    <script id="bd_news_box" type="text/x-tmpl">
        <div>
            <div class="builder_inner" id="home_box_{{= data}}">
                ...
                <div class="boxes_title">
                    <a class="handle " original-title="Move Box"><?php _e('MoveBox','bdayh') ?></a>
                    <a class="del" id="remove_{{= data}}" original-title="Remove Box"><?php _e('Remove Box','bdayh') ?></a>
                    <span class="settings"> <?php _e('Settings','bdayh') ?></span>
                    </div>
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
            ...
            <div class="builder_inner" id="home_box_{{= data}}">
                ...
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
                        ...
                        <div class="bd_option_item">
                            <h3><?php _e('Number of posts','bdayh') ?> </h3>
                            <input class="input_numb" name="bd_setting[home][{{= data}}][number]" type="text" value="6">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
                        ...
                        <div class="bd_option_item">
                            ...
                            <select id="bd_setting_home_{{= data}}_display" name="bd_setting[home][{{= data}}][display]">
                ...
                <div class="builder_content">
                    <div class="bd_item_content" style="display:none;">
                        ...
                        <div class="bd_option_item ads_img"  style="display:none;">
                            <h3><?php _e('Image Upload','bdayh') ?></h3>
                            ...
                            <div class="upload_img" id="bd_setting_home_{{= data}}_img" style="display:none;">
                                ...
                                <a href="#" class="remove_img btn" id="bd_setting_home_{{= data}}_remove"><?php _e('Remove','bdayh') ?></a>
                            </div>
                        <div class="bd_option_item">
                            <h3><?php _e('Ads Link','bdayh') ?> </h3>
                            <input type="text" name="bd_setting[home][{{= data}}][ad_link]" value="#">
                        </div>
                        <div class="bd_option_item">
                            <h3><?php _e('Alternate Name','bdayh') ?> </h3>
        ...
        <div class="builder_inner" id="home_box_<?php echo $k; ?>">
            ...
            <div class="builder_content">
                <div class="bd_item_content" style="display:none;">
                    ...
                    <div class="bd_option_item">
                        <h3>Layout Display </h3>
                        <select id="bd_setting_home_<?php echo $k; ?>_display" name="bd_setting[home][<?php echo $k; ?>][display]">
...
function home_videos_box($k,$arr)
{
    ...
    if(isset($wp_cats))
    {
        ?>
        <div class="builder_inner" id="home_box_<?php echo $k; ?>">
            <input type="hidden" name="bd_setting[home][<?php echo $k; ?>][type]" value="videos_box" />
...
function home_gallery_box($k,$arr)
{
    ...
    if(isset($wp_cats))
    {
        ?>
        <div class="builder_inner" id="home_box_<?php echo $k; ?>">
            <input type="hidden" name="bd_setting[home][<?php echo $k; ?>][type]" value="gallery_box" />
