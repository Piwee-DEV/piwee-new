...
<h2 class="page-info"><?php _e('Change Password', 'bd'); ?></h2>
...
<form action="<?php echo esc_url( get_permalink($post->ID) ); ?>" method="post" class="lost_reset_password">
    ...
    <p class="form-row form-row-first"><input class="input-text" type="text" name="user_login" id="user_login" placeholder="<?php _e( 'Username or email', 'woocommerce' ); ?>" /></p>
    ...
    <p class="form-row"><input type="submit" class="button comment-submit small" name="reset" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'woocommerce' ) : __( 'Save', 'woocommerce' ); ?>" /></p>
