...
<ul class="woocommerce-side-nav woocommerce-checkout-nav">
	<li class="active">
		<a href="#billing">
			<?php _e('Billing Address' , 'bd'); ?>
		</a>
	</li>
	<?php if($woo_shipping == true): ?>
	<li>
		<a href="#shipping">
			<?php _e('Shipping Address' , 'bd'); ?>
		</a>
	</li>
	<?php endif; ?>
	<li>
		<a href="#payment-container">
			<?php _e('Review &amp; Payment' , 'bd'); ?>
		</a>
	</li>
</ul>
...
<form name="checkout" method="post" class="checkout woocommerce-content-box" action="<?php echo esc_url( $get_checkout_url ); ?>">
	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<div class="" id="customer_details">
			...
			<div class="col-1" id="billing">
				...
				<a href="<?php echo ($woo_shipping) ? '#shipping' : '#payment-container'; ?>" class="default button small continue-checkout"><?php _e('Continue', 'bd'); ?></a>
			...
			<div class="col-2" id="shipping">
				...
				<a href="#payment-container" class="default button small continue-checkout"><?php _e('Continue', 'bd'); ?></a>
	...
	<div id="payment-container">
		<h2 id="order_review_heading"><?php _e( 'Review &amp Payment', 'bd' ); ?></h2>
