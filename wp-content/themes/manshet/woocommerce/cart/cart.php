...
<h2><?php echo sprintf(__('You Have %d items In Your Cart', 'woocommerce'), $woocommerce->cart->cart_contents_count); ?></h2>
						...
						<td class="product-thumbnail">
							<?php
								...
								if ( ! $_product->is_visible() || ( ! empty( $_product->variation_id ) && ! $_product->parent_is_visible() ) )
									...
									printf('<a class="product-thumbnail-url" href="%s">%s</a>', esc_url( get_permalink( apply_filters('woocommerce_in_cart_product_id', $values['product_id'] ) ) ), $thumbnail );
							?>
...
<div class="cart-collaterals clearfix">
	...
	<div class="one_half">
		...
		<h2><?php _e( 'Have A Promotional Code?', 'bd' ); ?></h2>
			<div class="coupon">

				<input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="button comment-submit small" name="apply_coupon" value="<?php _e( 'Apply', 'bd' ); ?>" />
