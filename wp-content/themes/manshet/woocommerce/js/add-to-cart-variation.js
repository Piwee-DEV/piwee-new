			        ...
			        if ( o_src ) {
						...
						image.onload=function(){
							if(jQuery('body').hasClass('has-sidebar')) { 
								new_height = 320/this.width*this.height; 
							} else { 
								new_height = this.height; 
							}
							jQuery('.woocommerce .images #slider .flex-viewport').css('height',new_height);
						}
						image.src=o_src;				        	
			        }
			        if ( o_href ) {
				...
				.on( 'found_variation', function( event, variation ) {
					...
					image.onload=function(){
						if(jQuery('body').hasClass('has-sidebar')) { 
					 	...
					 	jQuery('.woocommerce .images #slider .flex-viewport').css('height',new_height);
					 	jQuery('.woocommerce .images #slider').flexslider(0);
					}
					image.src = variation_image;
					image = jQuery(image);		
