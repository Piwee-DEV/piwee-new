...
function wpct_menu() {
	...
	add_menu_page( __( 'PIWEE Click Tracker', 'wp-click-track' ), __( 'PIWEE Click Tracker', 'wp-click-track' ),
		'edit_posts', $page_vars['default'], 'wpct_admin_module_template', plugins_url('images/logo-piwee.jpg' , __FILE__) );
